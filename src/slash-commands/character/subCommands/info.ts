import { CommandInteraction, ApplicationCommandSubCommand, Interaction, CommandInteractionOptionResolver } from "discord.js";
...
export const info = {
	async execute(commandInteraction: CommandInteraction) {
		// const username = commandInteraction.options("username")?.value || '';
		console.log("Executing info subcommand"), commandInteraction;
		return
		try {
